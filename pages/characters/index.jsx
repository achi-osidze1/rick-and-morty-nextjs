...
const CharactersPage = () => {
  ...
  async function fetchCharacters() {
    ...
    try {
      const response = await axios.get(
        `https://rickandmortyapi.com/api/character/?name=${search}&gender=${gender}&status=${status}&species=${species}&page=${page}`
      );
  ...
  return (
    <>
      ...
      <div className="mx-auto pt-12 p-4 sm:px-6 lg:max-w-7xl">
        <div className="flex flex-col my-3 lg:flex-row">
          ...
          <div className="w-full mx-auto lg:pl-4">
            ...
            {loading ? (
              ...
              <h1 className="flex justify-center items-center text-center my-6 text-2xl dark:text-white">
                {error}
              </h1>
            ) : (
