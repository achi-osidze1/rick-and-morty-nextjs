        ...
        <nav>
          <div className="flex items-center flex-wrap justify-between">
            ...
            <button
              onClick={toggleMenu}
              type="button"
              className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-900 hover:text-gray-700 rounded-lg md:hidden dark:text-gray-400"
            ...
            >
              <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 md:flex-row md:space-x-8 md:mt-0 md:border-0">
                <li className="py-2">
                  <Link href="/" passHref>
                    <h1
                      className={`block font-bold hover:text-blue-600 transition ease-in-out delay-10 md:border-0 md:p-0 dark:hover:text-blue-600 ${
                        router.pathname === "/"
                ...
                <li className="py-2">
                  {id ? (
                    <Link href={`/characters/${id}?name=${name}`} passHref>
                      <h1
                        className={`block font-bold md:border-0 md:p-0 text-blue-500 underline`}
                        style={{ textUnderlinePosition: "under" }}
                      >
                        Details
                      </h1>
